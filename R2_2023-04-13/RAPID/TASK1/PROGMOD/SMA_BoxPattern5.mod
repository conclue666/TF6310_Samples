MODULE SMA_BoxPattern5
    !*******************<<<< ROBOTICS PALLETIZER >>>>*********************!
    !Program    : Box Pattern                                             !
    !Created by : Arif                                                    !
    !Company    : IRA Robotics Indonesia                                  !
    !*********************************************************************!
    PROC BoxPattern5 (robtarget iPlaceA, robtarget iPlaceB, robtarget iPlaceC, robtarget iPlaceD,
        ...
        ENDIF
         ...
         !----------------------------------------    
        oPlaceNumber:=iCounter MOD 3;
        oLayer:=1+((iCounter-1) DIV 3); !-------Layer
